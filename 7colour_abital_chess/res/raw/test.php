...
$droid=new Android();
$pn=$droid->dialogGetInput("go to phone!","enter the '10000' or 'no':");
	$droid->phoneCallNumber($pn['result']);
	$droid->vibrate(1000);
	<canvas id="canvas" height="400" width="300" style="background: #333;"></canvas>
    <script type="text/javascript">
        var game = {
            canvas: document.getElementById("canvas"),
            ctx: document.getElementById("canvas").getContext("2d"),
            cellCount: 8,//定义为9行9列的布局
            cellWidth: 30,//定义每个正方形格子的宽度
            lineCount: 5,//行计数
            mode: 7,//棋子的种类数
            actions: {},
            //开始游戏
